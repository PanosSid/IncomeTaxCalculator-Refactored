...
public class ChartDisplay {
	...
	pieChartFrame.setLocation(450, 250);
	pieChartFrame.setVisible(true);
	return pieChartFrame;
    }

    private static ChartPanel createPieChartPanel(double entertainment, double basic, double travel, double health,
	    double other) {
	JFreeChart pieChart = ChartFactory.createPieChart("Percentage of the total amount of each kind of receipt.",
    ...
    private static DefaultPieDataset createDefaultPieDataset(double entertainment, double basic, double travel,
    ...
    public JFrame createBarChart(double basicTax, double taxVariation, double totalTax) {
	...
	barChartFrame.setLocation(950, 250);
	barChartFrame.pack();
//	RefineryUtilities.centerFrameOnScreen(barChartFrame);
	...
	JFreeChart barChart = ChartFactory.createBarChart("", "", "Tax analysis in $",
		createDefaultCategoryDataset(basicTax, taxVariation, totalTax), PlotOrientation.VERTICAL, true, true,
		false);
    ...
    private static DefaultCategoryDataset createDefaultCategoryDataset(double basicTax, double taxVariation,
	    double totalTax) {
