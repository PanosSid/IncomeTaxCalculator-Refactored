...
public class DataTagger {
    ...
    public static List<String> getTaggedTaxpayerAsList(List<String> taxpayerInfoData,
	    Map<Integer, List<String>> receiptsDataOfTaxpayer, List<List<String>> tags) {
	...
	List<String> justReceiptHeaders = receiptHeaders.subList(1, receiptHeaders.size()); // exclude receipts
											    // decleration
