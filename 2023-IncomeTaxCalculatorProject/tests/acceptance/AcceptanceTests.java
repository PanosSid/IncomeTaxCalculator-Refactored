...
public class AcceptanceTests {
	...
	taxpayerManager.createReceipt(1, "10/10/2010", (float) 100.0, "Basic", "aCompany1", "aCountry1", "aCity1", "aStreet1",  10, 111111111 );
	taxpayerManager.createReceipt(2, "20/2/2020", (float) 200.0, "Travel", "aCompany2", "aCountry2", "aCity2", "aStreet2", 20, 111111111 );
    ...
    @Test
    public void testUC1LoadTaxpayer() throws NumberFormatException, IOException,
    		WrongFileFormatException, WrongFileEndingException, WrongTaxpayerStatusException,
    ...
    @Test
    public void testUC3AddReceiptToTaxpayer() throws WrongReceiptDateException, IOException, 
    		WrongReceiptKindException, ReceiptAlreadyExistsException, InterruptedException {
	int receiptId = 3;
	...
	taxpayerManager.addReceipt(receiptId, issueDate, amount, kind,
	...
	for (int receiptKind = 0; receiptKind < 5; receiptKind++) {
	    double actualReceiptAmount = taxpayerManager.getTaxpayerAmountOfReceiptKind(taxRegistrationNumber, (short) receiptKind);
